...
Feature: The my overview block allows users to group courses by custom fields
  ...
  Scenario: Group courses by checkbox: Yes
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1             | block_eledia_telc_coursesearch |
      | customfiltergrouping       | checkboxfield | block_eledia_telc_coursesearch |
  ...
  Scenario: Group courses by date: 1 February 2001
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_eledia_telc_coursesearch |
      | customfiltergrouping       | datefield | block_eledia_telc_coursesearch |
    And I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
  ...
  Scenario: Group courses by select: Option 1
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1           | block_eledia_telc_coursesearch |
      | customfiltergrouping       | selectfield | block_eledia_telc_coursesearch |
    And I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
  ...
  Scenario: Group courses by text: fish
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_eledia_telc_coursesearch |
      | customfiltergrouping       | textfield | block_eledia_telc_coursesearch |
    And I am on the "My courses" page logged in as "student1"
    And I click on "All" "button" in the "Course overview" "block"
  ...
  Scenario: Hidden fields not displayed in the filter
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1          | block_eledia_telc_coursesearch |
      | customfiltergrouping       | textfield2 | block_eledia_telc_coursesearch |
